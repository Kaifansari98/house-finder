...
export type LeadTerminalSheetRef = {
  open: () => void;
  close: () => void;
};
...
const LeadTerminalSheet = forwardRef<LeadTerminalSheetRef, Props>(
  ({ leadId, referenceNo }, ref) => {
    /* ================= GLOBAL ================= */
          ...
          {item.followup && (
            <View style={styles.infoRow}>
              ...
              <Text style={styles.activityType}>
                {formatDateWithTime(item.followup)}
              </Text>
            </View>
          )}
        </View>
...
LeadTerminalSheet.displayName = "LeadTerminalSheet";

export default LeadTerminalSheet;
